...
namespace Lbrlabs.PulumiPackage.Launchdarkly.Inputs
{
    ...
    public sealed class GetWebhookStatementInputArgs : global::Pulumi.ResourceArgs
    {
        [Input("actions")]
        ...
        public GetWebhookStatementInputArgs()
        {
        }
        public static new GetWebhookStatementInputArgs Empty => new GetWebhookStatementInputArgs();
    }
}
