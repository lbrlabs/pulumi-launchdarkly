...
public final class AccessTokenPolicyStatementArgs extends com.pulumi.resources.ResourceArgs {

    public static final AccessTokenPolicyStatementArgs Empty = new AccessTokenPolicyStatementArgs();
    ...
    /**
     * @return The list of action specifiers defining the actions to which the statement applies.
     * 
     */
    ...
    /**
     * @return The list of action specifiers defining the actions to which the statement does not apply.
     * 
     */
    ...
    /**
     * @return - The list of resource specifiers defining the resources to which the statement does not apply.
     * 
     */
    ...
    /**
     * @return - The list of resource specifiers defining the resources to which the statement applies.
     * 
     */
    ...
    private AccessTokenPolicyStatementArgs() {}

    private AccessTokenPolicyStatementArgs(AccessTokenPolicyStatementArgs $) {
    ...
    public static Builder builder(AccessTokenPolicyStatementArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new AccessTokenPolicyStatementArgs();
        }

        public Builder(AccessTokenPolicyStatementArgs defaults) {
            $ = new AccessTokenPolicyStatementArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param actions The list of action specifiers defining the actions to which the statement applies.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param notActions The list of action specifiers defining the actions to which the statement does not apply.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param notResources - The list of resource specifiers defining the resources to which the statement does not apply.
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param resources - The list of resource specifiers defining the resources to which the statement applies.
         * 
         * @return builder
         * 
         */
        ...
        public AccessTokenPolicyStatementArgs build() {
