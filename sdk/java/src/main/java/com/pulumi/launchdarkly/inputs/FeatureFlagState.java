...
public final class FeatureFlagState extends com.pulumi.resources.ResourceArgs {
     ...
     * 
     */
    @Import(name="variationType")
    private @Nullable Output<String> variationType;

    /**
     * @return The feature flag&#39;s variation type: `boolean`, `string`, `number` or `json`.
     * 
     */
    public Optional<Output<String>> variationType() {
        return Optional.ofNullable(this.variationType);
    }
    ...
    public static final class Builder {
         ...
         * 
         */
        public Builder variationType(@Nullable Output<String> variationType) {
