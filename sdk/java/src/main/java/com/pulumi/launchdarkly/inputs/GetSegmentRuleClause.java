...
public final class GetSegmentRuleClause extends com.pulumi.resources.InvokeArgs {

    public static final GetSegmentRuleClause Empty = new GetSegmentRuleClause();
    ...
    private GetSegmentRuleClause() {}

    private GetSegmentRuleClause(GetSegmentRuleClause $) {
    ...
    public static Builder builder(GetSegmentRuleClause defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new GetSegmentRuleClause();
        }

        public Builder(GetSegmentRuleClause defaults) {
            $ = new GetSegmentRuleClause(Objects.requireNonNull(defaults));
        }
        ...
        public GetSegmentRuleClause build() {
