...
public final class RelayProxyConfigurationPolicyArgs extends com.pulumi.resources.ResourceArgs {

    public static final RelayProxyConfigurationPolicyArgs Empty = new RelayProxyConfigurationPolicyArgs();
    ...
    /**
     * @return The list of action specifiers defining the actions to which the rule policy applies. Either `actions` or `not_actions` must be specified. For a list of available actions read [Actions reference](https://docs.launchdarkly.com/home/account-security/custom-roles/actions#actions-reference).
     * 
     */
    ...
    /**
     * @return The list of action specifiers defining the actions to which the rule policy does not apply. Either `actions` or `not_actions` must be specified. For a list of available actions read [Actions reference](https://docs.launchdarkly.com/home/account-security/custom-roles/actions#actions-reference).
     * 
     */
    ...
    private RelayProxyConfigurationPolicyArgs() {}

    private RelayProxyConfigurationPolicyArgs(RelayProxyConfigurationPolicyArgs $) {
    ...
    public static Builder builder(RelayProxyConfigurationPolicyArgs defaults) {
    ...
    public static final class Builder {
        ...
        public Builder() {
            $ = new RelayProxyConfigurationPolicyArgs();
        }

        public Builder(RelayProxyConfigurationPolicyArgs defaults) {
            $ = new RelayProxyConfigurationPolicyArgs(Objects.requireNonNull(defaults));
        }

        /**
         * @param actions The list of action specifiers defining the actions to which the rule policy applies. Either `actions` or `not_actions` must be specified. For a list of available actions read [Actions reference](https://docs.launchdarkly.com/home/account-security/custom-roles/actions#actions-reference).
         * 
         * @return builder
         * 
         */
        ...
        /**
         * @param notActions The list of action specifiers defining the actions to which the rule policy does not apply. Either `actions` or `not_actions` must be specified. For a list of available actions read [Actions reference](https://docs.launchdarkly.com/home/account-security/custom-roles/actions#actions-reference).
         * 
         * @return builder
         * 
         */
        ...
        public RelayProxyConfigurationPolicyArgs build() {
