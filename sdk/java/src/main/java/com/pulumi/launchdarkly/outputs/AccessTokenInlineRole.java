...
@CustomType
public final class AccessTokenInlineRole {
    /**
    ...
    public static Builder builder(AccessTokenInlineRole defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resources;
        public Builder() {}
        public Builder(AccessTokenInlineRole defaults) {
        ...
        public AccessTokenInlineRole build() {
            final var o = new AccessTokenInlineRole();
            o.actions = actions;
            o.effect = effect;
