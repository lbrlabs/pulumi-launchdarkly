...
@CustomType
public final class AccessTokenPolicyStatement {
    /**
    ...
    public static Builder builder(AccessTokenPolicyStatement defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resources;
        public Builder() {}
        public Builder(AccessTokenPolicyStatement defaults) {
        ...
        public AccessTokenPolicyStatement build() {
            final var o = new AccessTokenPolicyStatement();
            o.actions = actions;
            o.effect = effect;
