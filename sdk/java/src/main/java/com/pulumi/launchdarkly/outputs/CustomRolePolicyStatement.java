...
public final class CustomRolePolicyStatement {
    ...
    public static Builder builder(CustomRolePolicyStatement defaults) {
    ...
    public static final class Builder {
        ...
        private @Nullable List<String> resources;
        public Builder() {}
        public Builder(CustomRolePolicyStatement defaults) {
        ...
        public CustomRolePolicyStatement build() {
            final var o = new CustomRolePolicyStatement();
            o.actions = actions;
            o.effect = effect;
