...
import com.pulumi.launchdarkly.outputs.GetSegmentRuleClause;
...
@CustomType
public final class GetSegmentRule {
    /**
     ...
     * 
     */
    public List<GetSegmentRuleClause> clauses() {
    ...
    public static final class Builder {
        ...
        public GetSegmentRule build() {
            final var o = new GetSegmentRule();
            o.bucketBy = bucketBy;
            o.clauses = clauses;
            o.weight = weight;
            return o;
